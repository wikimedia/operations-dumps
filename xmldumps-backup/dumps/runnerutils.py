...
class IndexHtml(object):
    ...
    report_dump_step_status = staticmethod(report_dump_step_status)
    ...
    report_file_size_status = staticmethod(report_file_size_status)
...
class StatusHtml(object):
    ...
    report_dump_status = staticmethod(report_dump_status)

    def get_statusfile_path(wiki, date):
        return os.path.join(wiki.public_dir(), date, "status.html")

    get_statusfile_path = staticmethod(get_statusfile_path)
