...
class TestFileLister(BaseDumpsTestCase):
    ...
    def test_xmlstubs_lister(self, _mock_get_some_stats, _mock_get_known_tables):
        ...
        building = self.dfsort(stubs_job.list_outfiles_for_build_command(self.en['dump_dir']))
        publish = self.dfsort(stubs_job.list_outfiles_to_publish(self.en['dump_dir']))
        ...
        cleanup_inprog = self.dfsort(stubs_job.list_inprog_files_for_cleanup(self.en['dump_dir']))
        cleanup = self.dfsort(stubs_job.list_outfiles_for_cleanup(self.en['dump_dir']))
        for_input = self.dfsort(stubs_job.list_outfiles_for_input(self.en['dump_dir']))
        ...
        cleanup_inprog = stubs_job.list_inprog_files_for_cleanup(self.en['dump_dir'])
        cleanup = stubs_job.list_outfiles_for_cleanup(self.en['dump_dir'])
        for_input = stubs_job.list_outfiles_for_input(self.en['dump_dir'])
        ...
        truncated = stubs_job.list_truncated_empty_outfiles(self.en['dump_dir'])
    ...
    def test_xmlcontent_lister(self):
        ...
        building = self.dfsort(articles_job.list_outfiles_for_build_command(self.en['dump_dir']))
        publish = self.dfsort(articles_job.list_outfiles_to_publish(self.en['dump_dir']))
        ...
        cleanup = self.dfsort(articles_job.list_outfiles_for_cleanup(self.en['dump_dir']))
        some_parts_articles = [
        ...
        for_input = self.dfsort(articles_job.list_outfiles_for_input(self.en['dump_dir']))
